...
PKG2_基类 = {
    ...
    ToBBuffer = function( bb, o )
        ...
        bb:WriteDouble( o.大波 )
        bb:WriteObject( o.湿最硬 )
        bb:WriteObject( o.屄拔扶儿 )
    end
}
...
PKG2_派生类 = {
    ...
    FromBBuffer = function( bb, o )
        ...
        o.立丝特白特 = bb:ReadObject()
        o.立丝特撕白特 = bb:ReadObject()
        o.立丝特吸哦特 = bb:ReadObject()
        o.立丝特又吸哦特 = bb:ReadObject()
        o.立丝特硬特 = bb:ReadObject()
        o.立丝特又硬特 = bb:ReadObject()
        o.立丝特浪 = bb:ReadObject()
        o.立丝特又浪 = bb:ReadObject()
        o.立丝特扶裸特 = bb:ReadObject()
        o.立丝特大波 = bb:ReadObject()
        o.立丝特湿最硬 = bb:ReadObject()
        o.立丝特屄拔扶儿 = bb:ReadObject()
        o.立丝特基类 = bb:ReadObject()
    end,
    ToBBuffer = function( bb, o )
        local p = getmetatable( o )
        p.__proto.ToBBuffer( bb, p )
        bb:WriteObject( o.立丝特白特 )
        bb:WriteObject( o.立丝特撕白特 )
        bb:WriteObject( o.立丝特吸哦特 )
        bb:WriteObject( o.立丝特又吸哦特 )
        bb:WriteObject( o.立丝特硬特 )
        bb:WriteObject( o.立丝特又硬特 )
        bb:WriteObject( o.立丝特浪 )
        bb:WriteObject( o.立丝特又浪 )
        bb:WriteObject( o.立丝特扶裸特 )
        bb:WriteObject( o.立丝特大波 )
        bb:WriteObject( o.立丝特湿最硬 )
        bb:WriteObject( o.立丝特屄拔扶儿 )
        bb:WriteObject( o.立丝特基类 )
    end
}
